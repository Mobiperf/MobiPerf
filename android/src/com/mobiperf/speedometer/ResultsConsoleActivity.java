...
public class ResultsConsoleActivity extends Activity {
  ...
  /**
   * Change the underlying adapter for the ListView depending on the old and new value of
   * showUserResults. userResults is the ArraytAdapter that stores user measurement results and
   * systemResults is the ArrayAdapter that stores system results. Depending on which one is the
   * underlying ArrayAdapter of consoleView, we see either user or system results.
   * 
