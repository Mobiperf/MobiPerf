...
public class Util {
  ...
  /**
   * Prepare the internal User-Agent string for use. This requires a {@link Context} to pull the
   * package name and version number for this application.
   */
  ...
  /**
   * Returns a String array that contains the ICMP sequence number and the round trip time extracted
   * from a ping output. The first array element is the sequence number and the second element is
   * the round trip time.
   * 
  ...
  /**
   * Returns an integer array that contains the number of ICMP requests sent and the number of
   * responses received. The first element is the requests sent and the second element is the
   * responses received.
   * 
   * Returns a null object if either element cannot be found.
   */
